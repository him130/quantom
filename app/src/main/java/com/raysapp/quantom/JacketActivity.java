...
public class JacketActivity extends AppCompatActivity {
    ...
    private static final String url = Constant.get_Jacket_category_url;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StringRequest request = new StringRequest(url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                rectview.setAdapter(new ProductResponseAdapter(JacketActivity.this,productResponse.getData()));
