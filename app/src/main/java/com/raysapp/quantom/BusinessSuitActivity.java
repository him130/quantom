...
public class BusinessSuitActivity extends AppCompatActivity {

    private static final String url = Constant.get_Suit_category_url;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_business_suit);
        ...
        StringRequest request = new StringRequest(url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                rectview.setAdapter(new ProductResponseAdapter(BusinessSuitActivity.this,productResponse.getData()));
