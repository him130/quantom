...
public class BlezerActivity extends AppCompatActivity {

    private static final String url = Constant.get_Blazer_category_url;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_blezer2);
        ...
        StringRequest request = new StringRequest(url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                rectview.setAdapter(new ProductResponseAdapter(BlezerActivity.this,productResponse.getData()));
